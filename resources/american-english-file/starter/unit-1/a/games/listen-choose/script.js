  ...
  function showPlay() {
    ...
    checkBtn.addEventListener("click", () => {
      ...
      if (selected === CORRECT) {
        ...
        feedback.textContent = "✓ Correct! Two teas and one cappuccino."; try{sfxCorrect();}catch(e){}
        setTimeout(showDone, 1200);
      } else {
        feedback.className = "lc-feedback no";
        feedback.textContent = "Not this one — listen again and try once more."; try{sfxWrong();}catch(e){}
        setTimeout(() => {
