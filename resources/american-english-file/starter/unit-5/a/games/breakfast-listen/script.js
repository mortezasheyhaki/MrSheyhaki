/* Breakfast Stories – select the food you hear · AEF Starter Unit 5A */
(function () {
  "use strict";
...
var GAME_ID = "starter-5a-breakfast-listen";

  // 5 chips each · correct = foods/drinks heard in the audio
  var PARTS = [
    {
      name: "Ashley, the US",
      audio: "https://cdn.imgurl.ir/uploads/n879222_Ashley.mp3",
      options: ["croissant", "coffee", "milk", "tea", "juice"],
      correct: ["croissant", "coffee", "milk"]
    },
    {
      name: "Paulo, Brazil",
      audio: "https://cdn.imgurl.ir/uploads/h559237_Paulo.mp3",
      options: ["fruit", "yogurt", "toast", "cereal", "eggs"],
      correct: ["fruit", "yogurt", "toast"]
    },
    {
      name: "Rob, Canada",
      audio: "https://cdn.imgurl.ir/uploads/l185858_Rob_2.mp3",
      options: ["coffee", "tea", "water", "juice", "bread"],
      correct: ["coffee"]
    },
    {
      name: "Sakura, Japan",
      audio: "https://cdn.imgurl.ir/uploads/h938735_Sakura.mp3",
      options: ["rice", "fish", "tea", "meat", "bread"],
      correct: ["rice", "fish", "tea"]
    }
  ];
  ...
  function finishGame() {
    stopAudio();
    phase = "done";
    var stars = score >= TOTAL ? 3 : score >= 3 ? 2 : score >= 2 ? 1 : 0;
    if (window.LAFinish) {
      try {
  ...
  function render() {
    if (phase === "start") {
      ...
      app.innerHTML =
        ...
        '<span class="bl-title">Breakfast Stories</span>' +
        '<span class="bl-badge">5A</span></header>' +
        '<section class="bl-start">' +
        '<div class="bl-hero" aria-hidden="true">🎧</div>' +
        "<h1>What do they have?</h1>" +
        '<p class="bl-sub">Listen to four people. Select the food and drinks you hear.</p>' +
    ...
    app.innerHTML =
      ...
      "</button>" +
      "<div><strong>Listen</strong><span>Select the food you hear</span></div>" +
      "</div>" +
      '<p class="bl-hint">Tap all the food and drinks you hear — then Check</p>' +
