/* Three Sounds Match · AEF Starter Unit 4A
   /ʌ/ up · /æ/ cat · /ə/ computer — joystick layout */
(function () {
  const GAME_ID = "starter-4a-three-sounds-match";

  // Example cues (not in the play queue)
  const EXAMPLES = {
    "ʌ": { word: "up", audio: "audio/up.mp3" },
    "æ": { word: "cat", audio: "audio/cat.mp3" },
    "ə": { word: "computer", audio: "audio/computer.mp3" },
  };

  const WORDS = [
    // /ʌ/ (up)
    { word: "husband", sound: "ʌ", audio: "audio/husband.mp3" },
    { word: "Sunday", sound: "ʌ", audio: "audio/sunday.mp3" },
    { word: "son", sound: "ʌ", audio: "audio/son.mp3" },
    { word: "mother", sound: "ʌ", audio: "audio/mother.mp3" },
    { word: "brother", sound: "ʌ", audio: "audio/brother.mp3" },
    // /æ/ (cat)
    { word: "man", sound: "æ", audio: "audio/man.mp3" },
    { word: "family", sound: "æ", audio: "audio/family.mp3" },
    { word: "bag", sound: "æ", audio: "audio/bag.mp3" },
    { word: "thanks", sound: "æ", audio: "audio/thanks.mp3" },
    { word: "that", sound: "æ", audio: "audio/that.mp3" },
    // /ə/ (computer)
    { word: "woman", sound: "ə", audio: "audio/woman.mp3" },
    { word: "children", sound: "ə", audio: "audio/children.mp3" },
    { word: "welcome", sound: "ə", audio: "audio/welcome.mp3" },
    { word: "parent", sound: "ə", audio: "audio/parent.mp3" },
  ];

  const DIR_TO_SOUND = { up: "ʌ", left: "æ", right: "ə" };
  const IPA = { "ʌ": "/ʌ/", "æ": "/æ/", "ə": "/ə/" };
  ...
  function renderMenu() {
    app.innerHTML = `
      ...
      <section class="ts-start">
        ...
        <div class="ts-howto">
          <div><span class="ts-arrow">↑</span> /ʌ/ &nbsp; up</div>
          <div><span class="ts-arrow">←</span> /æ/ &nbsp; cat &nbsp;&nbsp; <span class="ts-arrow">→</span> /ə/ &nbsp; computer</div>
        </div>
    ...
    app.innerHTML = `
      ...
      <div class="ts-stage">
        <div class="ts-pads-top">
          <button type="button" class="ts-pad ts-pad-up" id="pad-up" data-dir="up">↑ /ʌ/</button>
        </div>
        <div class="ts-pads-mid">
          <button type="button" class="ts-pad ts-pad-left" id="pad-left" data-dir="left">← /æ/</button>
          <button type="button" class="ts-pad ts-pad-right" id="pad-right" data-dir="right">→ /ə/</button>
        </div>
        ...
        <div class="ts-stick-wrap">
          <div class="ts-stick" id="ts-stick">
            <span class="ts-stick-label ts-stick-up">/ʌ/</span>
            <span class="ts-stick-label ts-stick-left">/æ/</span>
            <span class="ts-stick-label ts-stick-right">/ə/</span>
