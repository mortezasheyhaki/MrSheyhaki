/* Match Numbers 11–20 – 3 modes × 2 sets – AEF Starter Unit 2B
   Modes: Words ↔ Numbers | Audio ↔ Words | Audio ↔ Numbers
   Two sets of 5; auto-advance (no Next Round button)
*/
(function () {
  const GAME_ID = "starter-2b-match-numbers";
  ...
  function render() {
    ...
    if (phase === "menu") {
      app.innerHTML =
        ...
        '<span class="mc-title">Match Numbers</span>' +
