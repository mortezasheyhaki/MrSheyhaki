...
const questionBank = [
    ...
    {
        type: "positive",
        text: "There _____ three chairs in the kitchen.",
        options: ["is", "are", "am"],
        answer: "are"
    },
    {
        type: "positive",
        text: "There _____ a bathroom upstairs.",
        options: ["is", "are", "isn't"],
        answer: "is"
    },
    {
        type: "positive",
        text: "There _____ some apples in the fridge.",
        options: ["is", "are", "aren't"],
        answer: "are"
    },
    {
        type: "positive",
        text: "There _____ a big window in the living room.",
        options: ["is", "are", "am"],
        answer: "is"
    },
    ...
    {
        type: "negative",
        text: "There _____ a TV in the bedroom.",
        options: ["isn't", "aren't", "am not"],
        answer: "isn't"
    },
    {
        type: "negative",
        text: "There _____ any chairs in the garden.",
        options: ["isn't", "aren't", "am not"],
        answer: "aren't"
    },
    {
        type: "negative",
        text: "There _____ a garage at this house.",
        options: ["isn't", "aren't", "isn't any"],
        answer: "isn't"
    },
    {
        type: "negative",
        text: "There _____ any people in the park.",
        options: ["isn't", "aren't", "is"],
        answer: "aren't"
    },
    {
        type: "negative",
        text: "There _____ a swimming pool here.",
    ...
    {
        type: "question",
        text: "Is there a sofa in the living room?<br><br>Yes, _____.",
        options: ["there is", "there are", "it is"],
        answer: "there is"
    },
    {
        type: "question",
        text: "Are there any books on the shelf?<br><br>Yes, _____.",
        options: ["there is", "there are", "they are"],
        answer: "there are"
    },
    {
        type: "question",
        text: "Is there a bathroom downstairs?<br><br>No, _____.",
        options: ["there isn't", "there aren't", "it isn't"],
        answer: "there isn't"
    },
    {
        type: "question",
        text: "Are there any students in the classroom?<br><br>No, _____.",
        options: ["there isn't", "there aren't", "they aren't"],
        answer: "there aren't"
    },
    {
        type: "question",
        text: "Is there _____ milk in the fridge?",
        options: ["some", "any", "a"],
        answer: "any"
    }
